...
export default function Header(props) {
    return (
        <header className="bg-HeaderbgColor flex w-full justify-center">
            <nav className="flex w-8/12 items-center justify-center px-6 lg:px-8" >
                <div className="px-10 flex justify-center w-full py-5">
                    <Link to="/" className="-m-1.5 p-1">
                        <p className="text-white font-bold border-b border-white text-2xl capitalize">{props.title}</p>
                    </Link>
                </div>
